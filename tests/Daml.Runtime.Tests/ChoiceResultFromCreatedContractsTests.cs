...
/// </summary>
public class ChoiceResultFromCreatedContractsTests
{
        ...
        ContractId<AgreementRecord>? AgreementRecord)
    {
        public static ExerciseOutcome<ExecuteSwapResult> FromCreatedContracts(IEnumerable<CreatedContract> created)
        {
            ...
            {
                if (string.Equals(item.TemplateId.ModuleName, Tests.ChoiceResultFromCreatedContractsTests.Agreement.TemplateId.ModuleName, StringComparison.Ordinal)
                    && string.Equals(item.TemplateId.EntityName, Tests.ChoiceResultFromCreatedContractsTests.Agreement.TemplateId.EntityName, StringComparison.Ordinal))
                {
                    matches0.Add(item.ContractId);
                }
                else if (string.Equals(item.TemplateId.ModuleName, Tests.ChoiceResultFromCreatedContractsTests.SwapRecord.TemplateId.ModuleName, StringComparison.Ordinal)
                    && string.Equals(item.TemplateId.EntityName, Tests.ChoiceResultFromCreatedContractsTests.SwapRecord.TemplateId.EntityName, StringComparison.Ordinal))
                {
                    matches1.Add(item.ContractId);
                }
                else if (string.Equals(item.TemplateId.ModuleName, Tests.ChoiceResultFromCreatedContractsTests.AgreementRecord.TemplateId.ModuleName, StringComparison.Ordinal)
                    && string.Equals(item.TemplateId.EntityName, Tests.ChoiceResultFromCreatedContractsTests.AgreementRecord.TemplateId.EntityName, StringComparison.Ordinal))
                {
        ...
        ContractId<Half> HalfB)
    {
        public static ExerciseOutcome<SplitResult> FromCreatedContracts(IEnumerable<CreatedContract> created)
        {
            ...
            foreach (var item in created)
            {
                if (string.Equals(item.TemplateId.ModuleName, Tests.ChoiceResultFromCreatedContractsTests.Half.TemplateId.ModuleName, StringComparison.Ordinal)
                    && string.Equals(item.TemplateId.EntityName, Tests.ChoiceResultFromCreatedContractsTests.Half.TemplateId.EntityName, StringComparison.Ordinal))
                {
