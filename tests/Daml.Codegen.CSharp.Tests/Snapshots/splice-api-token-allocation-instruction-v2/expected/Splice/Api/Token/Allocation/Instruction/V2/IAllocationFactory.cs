...
public interface IAllocationFactory : IDamlInterface, IHasView<AllocationFactoryView>
{
    ...
    // Interface method AllocationFactory_Allocate.
    // Choice AllocationFactory_Allocate(AllocationFactory_Allocate) -> AllocationInstructionResult
    // Interface method AllocationFactory_PublicFetch.
    // Choice AllocationFactory_PublicFetch(AllocationFactory_PublicFetch) -> AllocationFactoryView
...
public static class IAllocationFactoryExtensions
{
    ...
    public static async Task<ExerciseOutcome<TransactionResult>> AllocationFactory_AllocateAsync(
        this ContractId<IAllocationFactory> contractId,
    ...
    /// <param name="timeout">Optional per-call deadline, enforced server-side; the default <c>null</c> applies no deadline. An overrun surfaces as an <c>InfraError</c> outcome.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    public static async Task<ExerciseOutcome<TransactionResult>> AllocationFactory_PublicFetchAsync(
        this ContractId<IAllocationFactory> contractId,
        ILedgerWriter client,
        AllocationFactory_PublicFetch argument,
        Party actAs,
