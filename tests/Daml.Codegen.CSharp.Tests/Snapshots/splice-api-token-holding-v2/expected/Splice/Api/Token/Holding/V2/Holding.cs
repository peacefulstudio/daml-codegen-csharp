...
/// <summary>
/// Phantom placeholder for the Daml interface <c>Splice.Api.Token.HoldingV2:Holding</c>.
...
/// interface <c>Splice.Api.Token.HoldingV2:Holding</c> has none, so every static metadata accessor on this
...
{
    /// <summary>Always throws — the <c>Splice.Api.Token.HoldingV2:Holding</c> interface placeholder carries no template identity.</summary>
    ...
    public static Identifier TemplateId =>
        throw new InvalidOperationException("'Holding' is the C# placeholder for the Daml interface 'Splice.Api.Token.HoldingV2:Holding' and carries no template metadata. Exercise interface choices directly on ContractId<Holding>; there is no supported coercion to a concrete ContractId<TConcrete>.");

    /// <summary>Always throws — the <c>Splice.Api.Token.HoldingV2:Holding</c> interface placeholder carries no package identity.</summary>
    ...
    /// <summary>Always throws — the <c>Splice.Api.Token.HoldingV2:Holding</c> interface placeholder carries no Daml type identity.</summary>
