...
public sealed partial record TokenTransferOffer(
    [property: DamlFieldAttribute("transfer")] Splice.Api.Token.Transfer.Instruction.V1.Transfer Transfer
) : ITemplate, IImplements<Splice.Api.Token.Transfer.Instruction.V1.ITransferInstruction>, IImplements<Splice.Api.Token.Holding.V1.IHolding>, IDamlRecord<TokenTransferOffer>
{
    ...
    public sealed record Contract(ContractId Id, TokenTransferOffer Data) : IContract<ContractId, TokenTransferOffer>
    {
        ...
        public static Contract FromCreatedEvent(CreatedEvent @event) =>
            new(new ContractId(@event.ContractId), global::Splice.Test.Token.V1.TokenTransferOffer.FromRecord(@event.CreateArguments));
    }
}
