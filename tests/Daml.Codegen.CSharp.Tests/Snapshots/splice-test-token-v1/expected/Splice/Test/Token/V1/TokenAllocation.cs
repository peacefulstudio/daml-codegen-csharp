...
public sealed partial record TokenAllocation(
    [property: DamlFieldAttribute("allocation")] Splice.Api.Token.Allocation.V1.AllocationSpecification Allocation
) : ITemplate, IImplements<Splice.Api.Token.Holding.V1.IHolding>, IImplements<Splice.Api.Token.Allocation.V1.IAllocation>, IDamlRecord<TokenAllocation>
{
    ...
    public sealed record Contract(ContractId Id, TokenAllocation Data) : IContract<ContractId, TokenAllocation>
    {
        ...
        public static Contract FromCreatedEvent(CreatedEvent @event) =>
            new(new ContractId(@event.ContractId), global::Splice.Test.Token.V1.TokenAllocation.FromRecord(@event.CreateArguments));
    }
}
