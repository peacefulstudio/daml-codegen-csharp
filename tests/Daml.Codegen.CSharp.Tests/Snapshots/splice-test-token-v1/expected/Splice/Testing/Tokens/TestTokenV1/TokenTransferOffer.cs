...
/// </summary>
public sealed partial record TokenTransferOffer(
    [property: DamlFieldAttribute("transfer")] global::Splice.Api.Token.TransferInstructionV1.Transfer Transfer
) : ITemplate, IImplements<global::Splice.Api.Token.TransferInstructionV1.ITransferInstruction>, IImplements<global::Splice.Api.Token.HoldingV1.IHolding>, IHasChoices<TokenTransferOffer>, IDamlRecord<TokenTransferOffer>
{
    /// <summary>Gets the template identifier.</summary>
    public static Identifier TemplateId { get; } = new("da294b5651ed00af8565fd31351d0c1d8778f10393d250e32c9844311f681436", "Splice.Testing.Tokens.TestTokenV1", "TokenTransferOffer");
    ...
    public static TokenTransferOffer FromRecord(DamlRecord record) => new TokenTransferOffer(
        Transfer: global::Splice.Api.Token.TransferInstructionV1.Transfer.FromRecord(record.GetRequiredField("transfer").As<DamlRecord>())
    );
    ...
    public static DamlRecord __ReadDamlLfJson(global::System.Text.Json.JsonElement json, global::Daml.Runtime.Serialization.DamlLfJsonDecodeContext context)
    {
        ...
        return DamlRecord.Create(
            DamlField.Create("transfer", global::Splice.Api.Token.TransferInstructionV1.Transfer.__ReadDamlLfJson(global::Daml.Runtime.Serialization.DamlLfJsonDecoders.RequireField(json, context, "transfer"), context.Field("transfer")))
        );
    }
    ...
    public sealed record Contract(ContractId Id, TokenTransferOffer Data) : IContract<ContractId, TokenTransferOffer>
    {
        ...
        public static Contract FromCreatedEvent(CreatedEvent @event) =>
            new(new ContractId(@event.ContractId), global::Splice.Testing.Tokens.TestTokenV1.TokenTransferOffer.FromRecord(@event.CreateArguments));
    }
}
