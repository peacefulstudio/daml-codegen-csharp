...
public class SuitRoundTripTests
{
    ...
    public void every_constructor_round_trips_through_DamlEnum(Suit original)
    {
    ...
    [Fact]
    public void clubs_serializes_to_bare_string_wire_shape()
    {
    ...
    [Fact]
    public void spades_round_trips_through_json_deserialization_given_the_wire_type_back()
    {
    ...
    [Fact]
    public void from_daml_enum_throws_for_an_unrecognized_constructor()
    {
    ...
    [Fact]
    public void to_daml_enum_throws_for_a_value_outside_the_declared_range()
    {
        var invalid = (Suit)99;
