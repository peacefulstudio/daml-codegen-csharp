...
public sealed class ProjectFileGenerator
{
        ...
        IReadOnlyList<DamlPackage> externalReferences)
    {
        ...
        sb.AppendLine(CultureInfo.InvariantCulture, $"    <TargetFramework>{EmitterHelpers.EscapeXmlText(_options.TargetFramework)}</TargetFramework>");
        ...
        sb.AppendLine(CultureInfo.InvariantCulture, $"    <Description>C# bindings for Daml package {EmitterHelpers.EscapeXmlText(package.Name)}</Description>");
        sb.AppendLine("    <Authors>Generated by Daml.Codegen.CSharp</Authors>");
        sb.AppendLine(CultureInfo.InvariantCulture, $"    <PackageLicenseExpression>{EmitterHelpers.EscapeXmlText(_options.PackageLicenseExpression)}</PackageLicenseExpression>");
        ...
        {
            var repositoryUrl = EmitterHelpers.EscapeXmlText(_options.RepositoryUrl);
        ...
        sb.AppendLine(CultureInfo.InvariantCulture, $"    <PackageTags>{EmitterHelpers.EscapeXmlText($"daml;canton;codegen;generated;{package.Name}")}</PackageTags>");
        sb.AppendLine("  </PropertyGroup>");
        sb.AppendLine();
        ...
        var runtimeVersion = EmitterHelpers.EscapeXmlText(_options.RuntimePackageVersion ?? EmitterLockstepVersion);
