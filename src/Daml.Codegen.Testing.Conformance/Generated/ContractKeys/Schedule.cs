...
) : ITemplate, IHasKey<Schedule, global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey>, IDamlRecord<Schedule>
{
    ...
    public static KeyDescriptor<Schedule, global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey> Key { get; } =
        new()
        {
    ...
    public static ExerciseByKeyCommand ArchiveByKeyCommand(
        global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey key)
    {
    ...
    public sealed record Contract(ContractId Id, Schedule Data) : IContract<ContractId, Schedule>
    {
        ...
        public required ContractKey<global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey> Key { get; init; }
        ...
        public static Contract FromCreatedEvent(CreatedEvent @event) =>
                ...
                global::Daml.Codegen.Testing.Conformance.ContractKeys.Schedule.FromRecord(@event.CreateArguments))
            {
                Key = @event.ContractKey is { } contractKey
                    ? new ContractKey<global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey>(global::Daml.Codegen.Testing.Conformance.KeyBuilders.ScheduleKey.FromRecord(contractKey.Value.As<DamlRecord>()), contractKey.KeyHash)
...
)
{
    ...
    public static ExerciseOutcome<RescheduleResult> FromCreatedContracts(IEnumerable<CreatedContract> created)
    {
        ...
        if (matches0.Count > 1)
        {
            return new ExerciseOutcome<RescheduleResult>.Many(EquatableArray.Create(matches0));
        }
