...
public static class ContractIdentifiers
{
    ...
    /// <summary>
    /// Gets the fully qualified template identifier for TypeCorners contracts.
    /// Format: {packageName}:RichTypes:TypeCorners
    /// </summary>
    public static string TypeCorners { get; } = GetTemplateId<TypeCorners>();
}
